...
| Part | Qty | Source / link | ADR |
|---|---|---|---|
| Custom wheel-holder plate (90.5x80.5x7mm, 4 corner mounting holes + diamond-grid hole/slot pattern) | 3: one per connection point — 2 for X-axis gantry legs (one per leg), 1 for the Y-axis carriage — see [hardware/laser-cut/20x40.stl](../hardware/laser-cut/20x40.stl) | user-provided design, placed alongside the gantry end caps; sourcing/material (printed vs. machined) not yet decided. Confirmed off-the-shelf aluminum alternative exists if needed: [Walmart](https://www.walmart.com/ip/1-Pack-Assembled-2040-V-Gantry-Plate-Kit-6pcs-V-Solid-POM-Wheels-Compatible-2040-4040-Series-V-Slot-Aluminum-Extrusion-Profiles-Linear-Rail-3D-Printe/15442272326), ~$18.99/plate, 6 wheels pre-mounted | [0040](decisions/0040-x-axis-v-wheel-gantry.md), [0039](decisions/0039-y-axis-single-rail-dual-block.md) — **not yet redesigned**: gantry end cap's carriage-attachment zone still cut for MGN12H's bolt pattern, needs redrawing to bolt to this plate's hole pattern instead |
| Delrin Mini V-Wheel kit, assembled (wheel + MR105ZZ bearing + 6mm eccentric spacer) | 2x 10-pack (need 12: 2 X-axis gantry legs x 4 wheels + 4 on the Y-axis carriage, reinforcing the rail against wiggle) | [eBay](https://www.ebay.com/itm/404701554316), $16.00/10-pack x2 = $32.00 (~$1.60/wheel), 8 spares | [0040](decisions/0040-x-axis-v-wheel-gantry.md), [0039](decisions/0039-y-axis-single-rail-dual-block.md) — 4 wheels bolt to each single wheel-holder plate above |
