...
| Y-axis gantry plate (motor side + bearing side) | 2 (1 each) | 5mm black acrylic (working assumption, reference plate was 8mm) | [hardware/laser-cut/y-gantry-plate.svg](../hardware/laser-cut/y-gantry-plate.svg) — user-authored final design | [0047](decisions/0047-captured-belt-custom-plates.md) — **verify** 5mm thickness holds up under load. Attaches to the 2040 beam at 6 points: 2 tapped directly into the extrusion end + 4 through slotted L-bracket holes (slotted since no reliable reference exists for the bracket's exact hole spacing) |
